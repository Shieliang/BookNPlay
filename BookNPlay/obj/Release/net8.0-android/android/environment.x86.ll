...
@dso_cache = dso_local local_unnamed_addr global [894 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1064882580, ; hash 0x3f78d194, from name: Auth0.OidcClient
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1122329274, ; hash 0x42e562ba, from name: Auth0.OidcClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Auth0.OidcClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 206
	...
	%struct.DSOCacheEntry {
		i64 1226106090, ; hash 0x4914e4ea, from name: BookNPlay
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1303510003, ; hash 0x4db1fbf3, from name: Auth0.OidcClient.Core
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1332592882, ; hash 0x4f6dc0f2, from name: libaot-Auth0.OidcClient.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Auth0.OidcClient.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 253
	...
	%struct.DSOCacheEntry {
		i64 1505516489, ; hash 0x59bc5bc9, from name: libaot-Auth0.OidcClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Auth0.OidcClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 306
	%struct.DSOCacheEntry {
		i64 1507325309, ; hash 0x59d7f57d, from name: JWT.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1788504013, ; hash 0x6a9a67cd, from name: BookNPlay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookNPlay.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	%struct.DSOCacheEntry {
		i64 1803529438, ; hash 0x6b7facde, from name: aot-Auth0.OidcClient.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Auth0.OidcClient.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 354
	...
	%struct.DSOCacheEntry {
		i64 2002620670, ; hash 0x775d90fe, from name: libaot-JWT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libaot-JWT.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
	...
	%struct.DSOCacheEntry {
		i64 2075600387, ; hash 0x7bb72603, from name: aot-Auth0.OidcClient
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Auth0.OidcClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 419
	...
	%struct.DSOCacheEntry {
		i64 2148015143, ; hash 0x80081c27, from name: Auth0.OidcClient.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Auth0.OidcClient.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 435
	...
	%struct.DSOCacheEntry {
		i64 2377115145, ; hash 0x8dafe609, from name: aot-BookNPlay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookNPlay.dll.so
		ptr null; void* handle (0x0)
	}, ; 484
	...
	%struct.DSOCacheEntry {
		i64 2457492528, ; hash 0x927a5c30, from name: aot-Auth0.OidcClient.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Auth0.OidcClient.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 506
	...
	%struct.DSOCacheEntry {
		i64 2502290808, ; hash 0x9525ed78, from name: JWT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libaot-JWT.dll.so
		ptr null; void* handle (0x0)
	}, ; 516
	...
	%struct.DSOCacheEntry {
		i64 2552148340, ; hash 0x981eb174, from name: aot-JWT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libaot-JWT.dll.so
		ptr null; void* handle (0x0)
	}, ; 523
	...
	%struct.DSOCacheEntry {
		i64 2799400881, ; hash 0xa6db77b1, from name: libaot-JWT.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libaot-JWT.dll.so
		ptr null; void* handle (0x0)
	}, ; 578
	...
	%struct.DSOCacheEntry {
		i64 2917934185, ; hash 0xadec2469, from name: libaot-Auth0.OidcClient.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Auth0.OidcClient.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 605
	...
	%struct.DSOCacheEntry {
		i64 3007211469, ; hash 0xb33e67cd, from name: libaot-BookNPlay
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookNPlay.dll.so
		ptr null; void* handle (0x0)
	}, ; 622
	...
	%struct.DSOCacheEntry {
		i64 3357325071, ; hash 0xc81cb70f, from name: aot-BookNPlay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookNPlay.dll.so
		ptr null; void* handle (0x0)
	}, ; 700
	...
	%struct.DSOCacheEntry {
		i64 3598566676, ; hash 0xd67dc514, from name: libaot-Auth0.OidcClient
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Auth0.OidcClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 755
	...
	%struct.DSOCacheEntry {
		i64 4042528304, ; hash 0xf0f41630, from name: libaot-BookNPlay.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-BookNPlay.dll.so
		ptr null; void* handle (0x0)
	}, ; 839
	...
	%struct.DSOCacheEntry {
		i64 4129382326, ; hash 0xf6215fb6, from name: aot-JWT
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.14_name, ; name: libaot-JWT.dll.so
		ptr null; void* handle (0x0)
	}, ; 858
	...
	%struct.DSOCacheEntry {
		i64 4207487161, ; hash 0xfac928b9, from name: aot-Auth0.OidcClient.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Auth0.OidcClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 877
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [179 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
